...
extension FotoCell {
    ...
    func setupConstraints() {
        ...
        likeButton.topAnchor.constraint(equalTo: photoImageView.topAnchor, constant: 8).isActive = true
        likeButton.rightAnchor.constraint(equalTo: photoImageView.rightAnchor, constant: -8).isActive = true
